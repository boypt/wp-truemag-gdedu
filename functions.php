...
function cactusthemes_scripts_styles() {
	...
	wp_enqueue_style( 'videojs' );
        ...
        #wp_enqueue_style( 'gdedu-o-common', get_template_directory_uri() . '/css/common.css');
        wp_enqueue_script( 'gdedu-pptbox', get_template_directory_uri() . '/js/pptBox.js', array(), '20130115', false );
	...
	wp_enqueue_style( 'google-font', '/p/fonts.googleapis.com/css?family='.$all_font );
     */
    ...
    wp_enqueue_style( 'gdedu-o-css', get_template_directory_uri() . '/css/css.css');
    wp_enqueue_style( 'gdedu-ed-css', get_template_directory_uri() . '/gdedu.css');
}
