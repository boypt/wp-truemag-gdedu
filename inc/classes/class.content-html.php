...
class CT_ContentHtml{
	...
	/* 
	 * Get item for content box
	 *
	 */
	function get_item_video($thumb, $show_title, $show_rate, $show_dur, $themes_pur){	
		global $_device_;
		global $_is_retina_;
	...
	$format = get_post_format(get_the_ID());
	  ...
	  $html .= '
	  		<div class="qv_tooltip"  title="
				<h4 class=\'gv-title\'>'.strip_tags(get_the_title()).'</h4>
				<div class=\'gv-ex\' >'.strip_tags(get_the_excerpt()).'</div>
				<div class= \'gv-button\'>
					<div class=\'quick-view\'><a href='.get_permalink().' title=\''.strip_tags(get_the_title()).'\'>'.__('Watch Now','cactusthemes').'</a></div>
	 ...
	 *
	 */
	function get_item_medium_video($thumb,$show_title, $show_exceprt, $show_rate,$show_dur,$show_view,$show_com,$show_like, $show_aut,$show_date, $themes_pur,$number_excerpt){
		global $_device_;
		global $_is_retina_;
		if($_device_== 'mobile' && !$_is_retina_){
			$thumb=($thumb=='thumb_520x293')?'thumb_260x146':(($thumb=='thumb_260x146')?'thumb_130x73':$thumb);
	 ...
	 *
	 */
	function get_item_small_video($thumb,$show_title, $show_rate,$show_dur,$themes_pur){	
		global $_device_;
		global $_is_retina_;
		if($_device_== 'mobile' && !$_is_retina_){
			$thumb=($thumb=='thumb_520x293')?'thumb_260x146':(($thumb=='thumb_260x146')?'thumb_130x73':$thumb);
	 ...
	 *
	 */
	function get_item_single_video($thumb,$show_title, $show_exceprt, $show_rate,$show_dur,$show_view,$show_com,$show_like, $show_aut,$show_date,$themes_pur,$number_excerpt){	
		global $_device_;
		global $_is_retina_;
		if($_device_== 'mobile' && !$_is_retina_){
			$thumb=($thumb=='thumb_520x293')?'thumb_260x146':(($thumb=='thumb_260x146')?'thumb_130x73':$thumb);
	 ...
	 *
	 */
	function get_all_item_video($item,$num_item,$column,$layout, $show_title, $show_exceprt, $show_rate,$show_dur,$show_view,$show_com,$show_like, $show_aut,$show_date, $themes_pur,$num_r,$number,$row,$class_cssit,$number_excerpt){
		$html='';	
		if($layout=='grid'){
			if($column==4){
				if($item==1 ||($item%5==1) ){$html .= '
					<div class="col-md-6 col-sm-12"> '.$this->get_item_video($thumb='thumb_520x293', $show_title, $show_rate,$show_dur,$themes_pur).' </div>';
				}else {$html .= '
					<div class="col-md-3 col-sm-6 col-xs-6"> '.$this->get_item_video($thumb='thumb_260x146', $show_title, $show_rate,$show_dur,$themes_pur).' </div>';
				}
				...
				$html .= '<div class="col-md-6 col-sm-12">'.$this->get_item_video($thumb='thumb_520x293', $show_title, $show_rate,$show_dur,$themes_pur).' </div>';
				...
				if($item==1 ||($item%9==1) ){$html .= '
					<div class="col-md-4 col-sm-12"> '.$this->get_item_video($thumb='thumb_520x293', $show_title, $show_rate,$show_dur,$themes_pur).' </div>';
				}else {$html .= '
					<div class="col-md-2 col-sm-6 col-xs-6"> '.$this->get_item_video($thumb='thumb_260x146', $show_title, $show_rate,$show_dur ,$themes_pur).' </div>';
				}
		...
		}else if($layout=='small_carousel')
		{
			if($column==4){
				$html .= '
				<div class="col-md-3 col-sm-6 col-xs-6"> '.$this->get_item_small_video($thumb='thumb_260x146', $show_title, $show_rate, $show_dur,$themes_pur).' </div>';
				if($row > 1){
				...
				$html .= '<div class="col-md-3 col-sm-6 col-xs-6">'.$this->get_item_small_video($thumb='thumb_260x146', $show_title, $show_rate,$show_dur,$themes_pur).' </div>';
				if($row > 1){
				...
				$html .= '
					<div class="col-md-2 col-sm-6 col-xs-6"> '.$this->get_item_small_video($thumb='thumb_260x146',$show_title, $show_rate,$show_dur,$themes_pur).' </div>';
				if($row > 1){
		...
		}else if($layout=='medium_carousel')
		{
			if($column==2){
				$html .= '
				<div class="col-md-6 col-sm-6">'.$this->get_item_medium_video($thumb='thumb_520x293', $show_title, $show_exceprt, $show_rate,$show_dur,$show_view,$show_com,$show_like, $show_aut,$show_date,$themes_pur,$number_excerpt).' </div>';
				if($row > 1){
				...
				$html .= '<div class="col-md-6 col-sm-6">'.$this->get_item_medium_video($thumb='thumb_520x293', $show_title, $show_exceprt, $show_rate,$show_dur,$show_view,$show_com,$show_like, $show_aut,$show_date, $themes_pur,$number_excerpt).' </div>';
				if($row > 1){
					if($item%2==0 && $item < $num_item && $item%$num_r!=0){
						$html .= '</div><div class="row">';
					}else
				...
				$html .= '
					<div class="col-md-4 col-sm-6">'.$this->get_item_medium_video($thumb='thumb_520x293', $show_title, $show_exceprt, $show_rate,$show_dur,$show_view,$show_com,$show_like, $show_aut,$show_date, $themes_pur,$number_excerpt).' </div>';
				if($row > 1){
		...
		{
				$html .= $this->get_item_single_video($thumb='thumb_520x293', $show_title, $show_exceprt, $show_rate,$show_dur,$show_view,$show_com,$show_like, $show_aut,$show_date, $themes_pur,$number_excerpt);
				if($row > 1){
