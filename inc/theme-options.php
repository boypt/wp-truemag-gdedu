  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
	  ...
	  array(
        ...
        'desc'        => 'Enter custom value (in pixels, for example: 100) to matchs with your logo size',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'navigation',
        'rows'        => '',
	  ...
	  array(
        ...
        'label'       => 'Use video player in slider',
        'desc'        => 'Display player instead of thumbnail images (Use only for 2 Classy slider styles)',
        'std'         => '',
        'type'        => 'select',
        'section'     => 'home',
        'class'       => '',
